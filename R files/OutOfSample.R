...
png(filename= "task1.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
plot(log(dat1_task1$bandwidth), dat1_task1$dens.logloss, type = "b", lwd = 2, pch = 16, 
     xlab  = "log bandwidth", ylab = "Out-of-sample empirical loss",main = "Task 1")
lines(log(dat1_task1$bandwidth), dat2_task1$dens.logloss, type = "b", col = "red", lwd = 2, lty = 4, pch = 18)
lines(log(dat1_task1$bandwidth), dat3_task1$dens.logloss, type = "b", col = "blue", lwd = 2, lty = 3, pch = 17)
legend("topright", 
...
# mean_loss_task1 = apply(matrix(c(dat1_task1$dens.logloss, dat2_task1$dens.logloss, dat3_task1$dens.logloss), ncol = 3), 1, mean)
...
png(filename= "task2.png",  width = 5, height = 5, units = "in", res= 150, pointsize=11)
plot(log(dat1_task2$bandwidth), dat1_task2$dens.logloss, type = "b", lwd = 2, pch = 16, 
     xlab  = "log bandwidth", ylab = "Out-of-sample empirical loss", main = "Task 2")
lines(log(dat1_task2$bandwidth), dat2_task2$dens.logloss, type = "b", col = "red", lwd = 2, lty = 4, pch = 18)
lines(log(dat1_task2$bandwidth), dat3_task2$dens.logloss, type = "b", col = "blue", lwd = 2, lty = 3, pch = 17)
legend("topright", 
       legend = c("Fold 1", "Fold 2", "Fold 3"), 
       col = c("black", "red", "blue"), 
       pch = c(16,18,17), 
...
mean_loss_task2 = apply(matrix(c(dat1_task2$dens.logloss, dat2_task2$dens.logloss, dat3_task2$dens.logloss), ncol = 3), 1, mean)
...
png(filename= "task3.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
plot(log(dat1_task3$bandwidth), dat1_task3$dens.logloss, type = "b", lwd = 2, pch = 16, 
     xlab  = "log bandwidth", ylab = "Out-of-sample empirical loss", main = "Task 3")
lines(log(dat1_task3$bandwidth), dat2_task3$dens.logloss, type = "b", col = "red", lwd = 2, lty = 4, pch = 18)
lines(log(dat1_task3$bandwidth), dat3_task3$dens.logloss, type = "b", col = "blue", lwd = 2, lty = 3, pch = 17)
legend("topright", 
       legend = c("Fold 1", "Fold 2", "Fold 3"), 
       col = c("black", "red", "blue"), 
       pch = c(16,18,17), 
...
# mean_loss_task3 = apply(matrix(c(dat1_task3$dens.logloss, dat3_task3$dens.logloss, dat3_task3$dens.logloss), ncol = 3), 1, mean)
...
png(filename= "task4.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
plot(log(dat1_task4$bandwidth), dat1_task4$dens.logloss, type = "b", lwd = 2, pch = 16, 
     xlab  = "log bandwidth", ylab = "Out-of-sample empirical loss", main = "Task 4")
lines(log(dat1_task4$bandwidth), dat2_task4$dens.logloss, type = "b", col = "red", lwd = 2, lty = 4, pch = 18)
lines(log(dat1_task4$bandwidth), dat3_task4$dens.logloss, type = "b", col = "blue", lwd = 2, lty = 3, pch = 17)
legend("topright", 
       legend = c("Fold 1", "Fold 2", "Fold 3"), 
       col = c("black", "red", "blue"), 
       pch = c(16,18,17), 
...
# mean_loss_task4 = apply(matrix(c(dat1_task4$dens.logloss, dat2_task4$dens.logloss, dat3_task4$dens.logloss), ncol = 3), 1, mean)
...
png(filename= "task5.png",  width = 5, height = 5, units = "in", res= 150, pointsize=11)
plot(log(dat1_task5$bandwidth), dat1_task5$dens.logloss, type = "b", lwd = 2, pch = 16, 
     xlab  = "log bandwidth", ylab = "Out-of-sample empirical loss", main = "Task 5")
lines(log(dat1_task5$bandwidth), dat2_task5$dens.logloss, type = "b", col = "red", lwd = 2, lty = 4, pch = 18)
lines(log(dat1_task5$bandwidth), dat3_task5$dens.logloss, type = "b", col = "blue", lwd = 2, lty = 3, pch = 17)
legend("topright", 
       legend = c("Fold 1", "Fold 2", "Fold 3"), 
       col = c("black", "red", "blue"), 
       pch = c(16,18,17), 
...
# mean_loss_task5 = apply(matrix(c(dat1_task5$dens.logloss, dat2_task5$dens.logloss, dat3_task5$dens.logloss), ncol = 3), 1, mean)
...
png(filename= "task6.png",  width = 5, height = 5, units = "in", res= 150, pointsize=11)
plot(log(dat1_task6$bandwidth), dat1_task6$dens.logloss, type = "b", lwd = 2, pch = 16, 
     xlab  = "log bandwidth", ylab = "Out-of-sample empirical loss", main = "Task 6")
lines(log(dat1_task6$bandwidth), dat2_task6$dens.logloss, type = "b", col = "red", lwd = 2, lty = 4, pch = 18)
lines(log(dat1_task6$bandwidth), dat3_task6$dens.logloss, type = "b", col = "blue", lwd = 2, lty = 3, pch = 17)
legend("topright", 
       legend = c("Fold 1", "Fold 2", "Fold 3"), 
       col = c("black", "red", "blue"), 
       pch = c(16,18,17), 
...
# mean_loss_task6 = apply(matrix(c(dat1_task6$dens.logloss, dat2_task6$dens.logloss, dat3_task6$dens.logloss), ncol = 3), 1, mean)
# #plot
# set.seed(5202)
# grid6 = resample(
#   task = Task6,
...
result_table_tune = data.table(mean_bandwith_task1,log(mean_bandwith_task1), mean_loss_task1, mean_loss_task2, mean_loss_task3, mean_loss_task4, 
                               mean_loss_task5, mean_loss_task6)
write.csv(result_table_tune, "C:\\Users\\Ain Toha\\Dropbox\\Simulation\\resultOutOfSample.csv")

png("OutOfSample.png", units = "px", width=1000, height=1000, res = 100)
