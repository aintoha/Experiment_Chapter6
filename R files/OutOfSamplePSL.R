...
png(filename= "task1PSL.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
png(filename= "task2PSL.png",  width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
png(filename= "task3PSL.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
grid_task4$aggregate(msr("dens.squared"))
...
png(filename= "task4PSL.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
png(filename= "task5PSL.png",  width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
png(filename= "task6PSL.png",  width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
write.csv(result_table_tune_psl, "C:\\Users\\Ain Toha\\Dropbox\\Simulation\\resultOutOfSamplePSL.csv")

png("OutOfSamplePSL.png", units = "px", width=1000, height=1000, res = 100)
