...
png(filename= "task1_insample.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
png(filename= "task3_insample.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
png(filename= "task4_insample.png", width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
png(filename= "task5_insample.png",  width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
png(filename= "task6_insample.png",  width = 5, height = 5, units = "in", res= 150, pointsize=11)
...
write.csv(result_table_tune, "C:\\Users\\Ain Toha\\Dropbox\\Simulation\\resultInSample.csv")

png("InSample.png", units = "px", width=1000, height=1000, res = 100)
